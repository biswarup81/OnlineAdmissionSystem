...
class admin_class {
    ...
    function updateApplicationTable($iteration, $courseid, $courselevelid,$category,$input_num){
        ...
        $query2 = "SELECT a.Application_No, a.First_Name, a.Last_Name, a.Gurdian_Mobile_No, a.email, a.password, 
                ...
                . "a.course_level_id = '$courselevelid' and a.category = '$category' and a.flag = '9'"
                . "order by a.Total_Marks desc limit 0, $input_num";
    ...
    function prepareMailBodyAfterRankGeneration($id){
        ...
        $body = "<html><head><body >
                <div ><div >
                    ...
                    <p>ID : Use your E-Mail ID or Mobile Numberand password : $rowObj->password (Change your password from the panel)</p>
                    <h2>Instructions</h2>
                    <p><strong>STEP 1</strong>: Deposite Admission Fee of <b><u>RS. ".$application_FeeObj->TOTAL_FEE." </u></b>to ".$admin ->getConstant('BANK_NAME')." in the following Branchs. </p>
                    <p>".$admin ->getConstant('BRANCH_ACCOUNT')."</p>
