...
<html>
  <head>
    ...
    <title>Online Application : Apply Online
    </title>
    <style>
      .Submit_reset{
        width:65px;
    ...
    <script>
		...
		$('#disability-cert-tr').hide();
		$('#caste-cert-tr').hide();
		$('input[name=ph_radio3]').change(function(){
			var lIsPh=$("input[name='ph_radio3']:checked"). val();
			if(lIsPh==="YES"){
				$('#disability-cert-tr').show();
				$('#disability-cert').prop('required',true);
			}else{
				$('#disability-cert-tr').hide();
				$('#disability-cert').prop('required',false);
			}
		});
		$('input[name=radio3]').change(function(){
			var lCaste=$("input[name='radio3']:checked"). val();
			if(lCaste==="GEN"){
				$('#caste-cert-tr').hide();
				$('#caste-proof').prop('required',false);
			}else{
				$('#caste-cert-tr').show();
				$('#caste-proof').prop('required',true);
			}
		});
...
?>
                <div align="center">
                  <table width="100%">
                    <TR>
                      <td width="25%">
                        <img src="<?=$cdata['logo'];?>" width="195" height="163">
                      </td>
...
?>
                        ...
                        <br>
                        <font color="red">* All Fields are Mandatory.
                        </font>
                      </td>
                      <td width="10%">
                      </td>
            ...
            <tr bgcolor="#FFFFFF">
              <td width="250" class="sTD">
                <label>
                  <span class="style1">*
                  </span>First Name
                </label>
              </td>
              <td width="576" class="sTD">
                <input name="Your_name" type="text" id="Your_name" size="40" maxlength="39" style="text-transform:uppercase;" required>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="sTD">
                <input name="U_lname" type="text" id="U_lname" size="40" maxlength="39" style="text-transform:uppercase;" required>
              </td>
            </tr>
			<tr id="pp-photo-tr">
              <td>
...
<input type="text" name="desi" id="desi" style="text-transform:uppercase;"></td>
            ...
            <tr>
              ...
              <td class="sTD">
                <input name="radio2" type="radio" id="radio2" value="M" required="required"> Male
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<input name="U_gname222" type="text" id="U_gname222" size="20" maxlength="39" placeholder="Phone No" pattern="[0-9]{10}" onBlur="phnChk()">
            ...
            <tr>
              ...
              <td>
                ...
                <input name="email" type="email" id="email" size="50" maxlength="50" required="required">
              </td>
            </tr>
            <tr>
              <td bgcolor="#FF0000" class="sTD">
...
<option value="NA">NA</option>
            ...
            <tr>
              <td colspan="2">
                <span class="style8">
                  <span class="style6">
                    <span id="chkStatusText">Top Five Subjects + Honors Subject (For Honors) and Top Five Subjects (for General) 
                    </span>
          ...
          <tbody>
            ...
            <tr bgcolor="#FFFFCC">
              <td colspan="2" bgcolor="#FF9933">
                <br>
                <br>
                <font size="5">Payment Information:
                  <br>
                  <br>
                </font>		
              </td>
            ...
            <tr>
              <?php 
$PayStr=mysql_query("SELECT * FROM `admission_constant`");
while($reQ=mysql_fetch_array($PayStr)){
$payArr[]=$reQ['DESCRIPTION'];
}
?>
              <td width="250" class="sTD">
                <label>
                  <span class="style1">*
                  </span>Amount Deposite
                </label>
              </td>
              <td width="576" class="sTD">
                <input name="tst1" type="text" id="" size="40" maxlength="39" style="text-transform:uppercase;" required value="<?=$payArr[0];?>" readonly class="sTD">
              </td>
            </tr>
            <tr>
              <td width="250" class="sTD">
                <label>
                  <span class="style1">*
                  </span>Payment Date(MM/DD/YYYY)
                </label>
              </td>
              <td width="576" class="sTD">
                <input type="text" value="" required name="Payment_date" id="Payment_date" />
              </td>
            </tr>
            <tr>
              <td width="250" class="sTD">
              ...
              <td width="576" class="sTD">
                <input name="tst3" type="text" id="" size="40" maxlength="39" style="text-transform:uppercase;" required value="<?=$payArr[1];?>" class="sTD" readonly>
              </td>
            </tr>
            <tr>
              <td width="250" class="sTD">
              ...
              <td width="576" class="sTD">
                <input name="branch_name" type="text" id="branch_name" size="40" maxlength="39" style="text-transform:uppercase;" required value="">
              </td>
            </tr>
          </tbody>
        </table>
