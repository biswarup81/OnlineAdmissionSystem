...
?>
	  ...
	  <tr>
      <td>Marksheet</td>
      <td colspan="3">&emsp;<a class="thumb" href="#"><img src="images/imgicon.png" alt=""/><span><img src="data:image/png;base64,<?=base64_encode(file_get_contents('/pg/ulasset/'.$imagelinks->HS_Markheet_File_Name)) ?>" alt=""/></span></a></i></td>
	  </tr>
	  
	  <?php
	  if(!empty($imagelinks->Admisson_challan_File_name)){
	  ?>
	   <tr>
      <td>Admission Challan </td>
      <td colspan="3">&emsp;<a class="thumb" href="#"><img src="images/imgicon.png" alt=""/><span><img src="data:image/png;base64,<?=base64_encode(file_get_contents('/pg/ulasset/'.$imagelinks->Admisson_challan_File_name)) ?>" alt=""/></span></a></i></td>
	  </tr>
	   <?php
	   }
	   ?>
	   <?php
	  if(!empty($imagelinks->App_challan_File_name)){
	  ?>
	  <tr>
      <td>Application Challan </td>
      <td colspan="3">&emsp;<a class="thumb" href="#"><img src="images/imgicon.png" alt=""/><span><img src="data:image/png;base64,<?=base64_encode(file_get_contents('/pg/ulasset/'.$imagelinks->App_challan_File_name)) ?>" alt=""/></span></a></i></td>
	  </tr>
	  <?php
	   }
	   ?>
