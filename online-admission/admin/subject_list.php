...
include "top.php";
include "header.php";
$sort_fieldname='Subject_Id desc';
	...
	<tr>
		<td class="mainarea">		
            ...
            <form name="f1" method="post" action="<?=$listPage?>?action=search">
                ...
                <option value="Subject_Id" <?php if($search_for=="Subject_Id"){?> selected="selected"<?php }?>>Subject Id</option>
                <option value="Subject_Name" <?php if($search_for=="Subject_Name"){?> selected="selected"<?php }?>>Subject Name</option>
                </select></td>
	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" width="100%" align="left">
				  <td width="40%" class="caption">:Subject List </td>
				    <td class="endcap"></td>
				<td style="padding-left:10px;" align="right"><a href="<?=$addPage?>?edit=2">Add New Subject</a></td>
				<td align="left"></td>
			</table>
		</td>
	</tr>    
				...
				?>
                 ...
                 <tr align="center" class="colhead">
                    ...
                    <tr align="center" bgcolor="<?php echo $bg;?>" onMouseOver=bgColor="#EFF7FF" onMouseOut=bgColor="<?php echo $bg;?>">
						<td><?php echo $slno;?></td>
	                    <td><?php echo $f_arr['Subject_Name'];?></td>
                        <td align="center"><!--<a href="item_view?id=<?php echo $f_arr['id'];?>"><image src="images/view.png" width="20" height="20" ></a>&nbsp;&nbsp;<image src="images/pa.jpg" width="3" height="20">-->&nbsp;&nbsp;<a href="<?=$addPage?>?id=<?php echo $f_arr['Subject_Id'];?>&edit=1"><image src="images/edit.png" width="20" height="20"></a>&nbsp;&nbsp;
