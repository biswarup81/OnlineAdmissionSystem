		...
		<td>
			<table cellpadding="0" cellspacing="0" width="100%" align="left">
				  <td width="40%" class="caption">:Link List </td>
				    <td class="endcap"></td>
				<td style="padding-left:10px;" align="right"><a href="<?=$addPage?>?edit=2">Add New Fee Structure</a></td>
				<td align="left"></td>
			</table>
		</td>
	</tr>    
				...
				?>
                 ...
                 <tr align="center" class="colhead">
                    ...
                    <tr align="center" bgcolor="<?php echo $bg;?>" onMouseOver=bgColor="#EFF7FF" onMouseOut=bgColor="<?php echo $bg;?>">
						...
						echo $f_arr['TOTAL_FEE'];?><?php echo $f_arr[''];?></td>
                        <td align="center">&nbsp;&nbsp;<a href="<?=$addPage?>?id=<?php echo $f_arr['id'];?>&edit=1"><image src="images/edit.png" width="20" height="20"></a>&nbsp;&nbsp;
