...
if ($action == "delete") {
    $inputId = $_REQUEST['id'];
    $query = "DELETE from `course_table` where `CourseId`='" . $inputId . "'";
				...
				?>
                 ...
                 <tr align="center" class="colhead">
                    ...
                    <tr align="center" bgcolor="<?php echo $bg;?>" onMouseOver=bgColor="#EFF7FF" onMouseOut=bgColor="<?php echo $bg;?>">
					   ...
					   ?> 
                        <image src="images/pa.jpg" width="3" height="20">&nbsp;&nbsp;<a href="<?php echo $_SERVER['PHP_SELF'] ?>?action=delete&id=<?php echo $f_arr['CourseId'];?>"><image src="images/delete.png" width="20" height="20"></a>
                       <?php }?> 
