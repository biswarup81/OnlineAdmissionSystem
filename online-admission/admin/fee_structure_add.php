			...
			if($edit==1){
				...
				$print="<font color='#FF0000'>Value successfully Inserted.</font>";
                                    ...
                                    //mysql_query("INSERT INTO ".$table_fee_structure." (Course_Id,Course_Level_Id,TOTAL_FEE) VALUES ('$CourseId','$Course_Level_Id','$total_fee')")or die(mysql_error()) ;
                                      mysql_query("INSERT INTO fee_structure (Course_Id,Course_Level_Id,TOTAL_FEE) VALUES ('$CourseId','$Course_Level_Id','$total_fee') ");
					header('location:'.$listPage);
					$print="<font color='#FF0000'>Value successfully Inserted.</font>";
	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" width="40%" align="left">
				<td width="90%" class="caption">: Add New Fee Structure</td>
				<td class="endcap"></td>
			</table>
		</td>
	</tr>
    <tr>
		<td class="mainarea">
        	<table cellpadding="0" cellspacing="0" width="70%" align="left" border="0" style="padding-right:5px;" >
                <tr >
                    <td style="padding-right:5px;"><a href="index" style="padding-right:5px;">Home</a>&nbsp;<img src="images/arrow.png" >&nbsp;<a href="<?=$listPage?>">Fee Structure</a>&nbsp;<img src="images/arrow.png" >&nbsp;<?php if($edit==1){?><a href="<?=$addPage?>?id=<?=$id?>&edit=<?=$edit?>">Edit Fee Structure</a><?php }else{?><a href="<?=$addPage?>?edit=2">Add Fee Structure</a><?php }?></td>
                </tr>
            </table>
            <br><br>
