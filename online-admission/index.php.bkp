...
<?php 
$courseLevel_query=mysql_query("SELECT * FROM `course_level` where Course_Level_Id in ('4','7') ORDER BY `Course_Level_Id` ASC");
...
<td width="250" class="sTD"><label><span class="style1">*</span>Amount Deposite</label></td>
		...
		<td width="576" class="sTD"><input name="tst1" type="text" id="" size="40" maxlength="39" style="text-transform:uppercase;" required value="<?=$payArr[0];?>" readonly class="sTD"></td>
</tr>
<tr>
...
<td width="250" class="sTD"><label><span class="style1">*</span>Bank Name</label></td>
		...
		<td width="576" class="sTD"><input name="tst3" type="text" id="" size="40" maxlength="39" style="text-transform:uppercase;" required value="<?=$payArr[1];?>" class="sTD" readonly></td>
</tr>
<tr>
