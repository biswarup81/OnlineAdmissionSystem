				...
				?>
                 ...
                 <tr align="center" class="colhead">
                    ...
                    <tr align="center" bgcolor="<?php echo $bg;?>" onMouseOver=bgColor="#EFF7FF" onMouseOut=bgColor="<?php echo $bg;?>">
					   ...
					   ?> 
                        <image src="images/pa.jpg" width="3" height="20">&nbsp;&nbsp;<a href="item_delete?id=<?php echo $f_arr['id'];?>"><image src="images/delete.png" width="20" height="20"></a>
                       <?php }?> 
